...
#define BUFFER_SIZE    400          // Size of software receive buffer in bytes.
                                    // UART Send/Receive hardware buffers are 128 Bytes each

extern char str[40];                       // For data conversions and display (debug mostly)
